...
public class Instant_help extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(Instant_help.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Instant_help.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(Instant_help.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
